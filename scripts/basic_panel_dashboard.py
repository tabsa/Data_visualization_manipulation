"""
BASIC_PANEL_DASHBOARD

Script with a basic example on a dashboard with panel package.
This example replicates the example on panel documentation: https://panel.holoviz.org/tutorials/basic/build_dashboard.html
...
fig = (df[["p_year", "t_cap"]].groupby("p_year").sum() / 10**6).hvplot.bar(
